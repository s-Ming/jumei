...
class Jdetails extends React.Component {
        ...
        <div className="Jdeta_cu">
          <div className="Jdeta_cuxiao">
            ...
            <i
              ...
              aria-hidden="true"
              onClick={this.chang.bind(this, "cuxiao")}
            />
          </div>
          ...
          <p className="Jdeta_man2">
            18年12月1日0点到12月8日23点59分59秒期间内，购买巴黎欧莱雅满209减30
          </p>
        </div>
        <div className="Jdeta_cu">
          <p className="Jdeta_man1">
  ...
  car() {
    return (
      <div className="Jdeta_button">
        ...
        <button
          className="Jdeta_button_d2"
          onClick={this.goPage.bind(this, "d2")}
        >
          加入购物车
        </button>
        <button
          className="Jdeta_button_d3"
          onClick={this.goPage.bind(this, "d3")}
        >
          立即购买
        </button>
      </div>
  ...
  render() {
    return (
      <div>
        <Jheader name={this.state.goods.short_name} />
        {JSON.stringify(this.state.goods) != "{}" &&
        JSON.stringify(this.state.dy) != "{}" ? (
          <div className="Jdeta">
            <div className="Jdeta_img">
              <img src={this.state.goods.tag} alt="" className="Jdeta_i1" />
              <img
                src={this.state.goods.image_url_set.single_many[0]["480"]}
                alt=""
                className="Jdeta_i2"
              />
            </div>
            ...
            <p className="Jdeta_name">
              <span>{this.state.goods.special_tags.jm_owner}</span>
            ...
            <ul className="Jdeta_ping">{this.pinglun()}</ul>
            {this.car()}
          </div>
        ) : (
          "loading"
